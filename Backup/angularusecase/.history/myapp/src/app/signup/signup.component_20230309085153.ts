...
onsubmit(){
  this.loading=true;
  this.register.signuppage(this.data.name,this.data.email,this.data.password,this.data.phone,this.data.branch,this.data.date_of_birth,this.data.resident).subscribe(
    {
      next:data=>{
